...
cache_t cache[] = {
    ...
    { 0, TAG_EMS_AUTARKY, "e3dc/autarky", "%0.1f", "", RSCP::eTypeFloat32, 1, false },
    { 0, TAG_EMS_SELF_CONSUMPTION, "e3dc/self_consumption", "%0.1f", "", RSCP::eTypeFloat32, 1, false },
    { 0, TAG_EMS_BAT_SOC, "e3dc/battery/soc", "%0.1f", "", RSCP::eTypeFloat32, 1, false },
    { 0, TAG_EMS_MODE, "e3dc/mode", "%i", "", RSCP::eTypeUInt32, 1, false },
    { 0, TAG_EMS_STATUS, "e3dc/status", "%i", "", RSCP::eTypeUInt32, 1, false },
    { 0, TAG_EMS_EMERGENCY_POWER_STATUS, "e3dc/emergencypowerstatus", "%i", "", RSCP::eTypeUInt32, 1, false },
